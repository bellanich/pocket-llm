...
from .llava_onevision import llava_onevision_loader, llava_onevision_model, llava_onevision_quantization
...
MODELS: Dict[str, Model] = {
    ...
    "llava_onevision": Model(
        name="llava_onevision",
        model=llava_onevision_model.LlavaOnevisionForCausalLM,
        config=llava_onevision_model.LlavaOnevisionConfig,
        source={
            "huggingface-torch": llava_onevision_loader.huggingface,
            "huggingface-safetensor": llava_onevision_loader.huggingface,
            "awq": llava_onevision_loader.awq,
        },
        quantize={
            "group-quant": llava_onevision_quantization.group_quant,
            "no-quant": llava_onevision_quantization.no_quant,
            "awq": llava_onevision_quantization.awq_quant,
        },
    ),
    "rwkv6": Model(
        name="rwkv6",
